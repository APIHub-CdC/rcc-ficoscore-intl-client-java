...
public class PersonaPeticion {
  ...
  public PersonaPeticion residencia(Integer residencia) {
  ...
  public PersonaPeticion estadoCivil(String estadoCivil) {
  ...
  public PersonaPeticion sexo(String sexo) {
    this.sexo = sexo;
    return this;
  }
   
  @ApiModelProperty(example = "0000001", value = "0000001")
...
@ApiModelProperty(example = "M", value = "genero")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(folioOtorgante,apellidoPaterno, apellidoMaterno, apellidoAdicional, primerNombre, segundoNombre, fechaNacimiento, RFC, CURP, nacionalidad, residencia, estadoCivil, sexo, claveElectorIFE, numeroDependientes, fechaDefuncion, domicilio);
  }
  @Override
