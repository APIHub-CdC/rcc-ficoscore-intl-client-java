...
public class Banxico {
  ...
  @ApiModelProperty(example = "1214", value = "Indicar los últimos 4 dígitos del número que identifica la cuenta.")
  ...
  @ApiModelProperty(example = "V", value = "Si se cuenta con crédito hipotecario el valor es V (verdadero), de lo contrario el valor es F (falso).")
  ...
  @ApiModelProperty(example = "V", value = "Si se cuenta con crédito automotriz ejercido en los últimos 24 meses el valor es V (verdadero), de lo contrario el valor es F (falso).")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.tarjetaDeCredito, banxico.tarjetaDeCredito) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tarjetaDeCredito, numeroCuenta, creditoHipotecario, creditoAutomotriz);
  }
  @Override
  public String toString() {
