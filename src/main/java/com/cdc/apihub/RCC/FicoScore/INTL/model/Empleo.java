...
public class Empleo {
  ...
  @ApiModelProperty(example = "JAL", value = "")
  ...
  @ApiModelProperty(example = "15042019", value = "Debe de reportarse la fecha del último día de trabajo en esta empresa.")
  ...
  @ApiModelProperty(example = "14042019", value = "Debe de reportarse la fecha en que se verifico el puesto de trabajo en esta empresa.")
