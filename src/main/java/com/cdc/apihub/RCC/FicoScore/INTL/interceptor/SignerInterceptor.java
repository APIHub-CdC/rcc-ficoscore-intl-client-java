package com.cdc.apihub.RCC.FicoScore.INTL.interceptor;
...
import com.cdc.apihub.RCC.FicoScore.INTL.model.Errores;
...
public class SignerInterceptor implements Interceptor {
	...
	private String generateError(String code, String message) {
		...
		com.cdc.apihub.RCC.FicoScore.INTL.model.Error err = new com.cdc.apihub.RCC.FicoScore.INTL.model.Error();
		err.setCodigo(code);
